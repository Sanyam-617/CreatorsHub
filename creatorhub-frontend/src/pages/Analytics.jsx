...
export default function Analytics() {
  ...
  // Controls whether the full table is shown or just the first PREVIEW_ROWS
  ...
  // Reset table expansion whenever the selected platform changes
  useEffect(() => {
  ...
  // Reversed list for display (newest first)
  const reversedAnalytics = [...analytics].reverse();
  const displayedRows = tableExpanded ? reversedAnalytics : reversedAnalytics.slice(0, PREVIEW_ROWS);
  const hasMore = reversedAnalytics.length > PREVIEW_ROWS;
          ...
          <>
            ...
            {!loadingData && !dataError && summary && (
              <div className="analytics-content">
                ...
                {/* Data table — shows 3 rows by default, expand on demand */}
                {analytics.length > 0 && (
                    ...
                    {hasMore && (
                      ...
                      >
                        {tableExpanded ? (
                          ...
                          <><ChevronDown size={15} /> View All {reversedAnalytics.length} Entries</>
                        )}
                      </button>
                    )}
                  </div>
